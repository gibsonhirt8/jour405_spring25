...
I noticed that there are a lot of peaks within the chart and not necessarily any pattern of when an excess amount of calls occur. If I had to draw a horizontal line for a high amount of scores I would draw it around 18 calls and on the low end I would draw it around 3 calls.
...
I think I did a good job at estimating the places to draw a line for unusual days in task 3. I said that I would draw a line around 18 for days with an unusually high amount of calls and around 3 for days with a low amount. Looking at the sorted data, all of the unusually high days had at least 18 calls and all of the unusually low days had at most 3 calls.
...
On Tuesday, October 4, 2022, there were 23 calls to 911 for drug overdoses which is more than 50% higher than the average number of calls on Tuesdays -- 10.35.
...
I think a good angle to focus on would be that overdose calls decreased during the winter months and increased back up once the weather got nicer out again. I would tell my editor that I would want to take some time to examine the data within the winter and summer months and compare it to the average temperature either for each day or a week at a time. This would help me understand if overdose calls follow a pattern of increasing or decreasing depending on if the temperature is above a certain level both extremely hot or extremely cold.
