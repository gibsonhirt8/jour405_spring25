...
The data is skewed to the left as most of the data occurs to the right of the mean. After plotting the data, I can see that it is more likely that more than 12 cars (mean), are stolen per day, because a lot more data occurs within standard deviation to the right as opposed to the left.
