...
```{r}
set.seed(42) # Setting seed for reproductability
population <- tibble(
...
The mean and standard deviation of my sample of 100 is close the statistics for the entire population. However, when I re-run the sampling and statistic with a smaller sample size, the mean and standard deviation vary a lot more. As the sample size decreases, the variability increases.
