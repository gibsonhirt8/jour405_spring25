...
The correlation coefficient for this data was .018, meaning that there was an extremely weak positive correlation within the data. This coefficient is basically saying that the data is 99% unrelated. The scatterplot confirmed the findings of the correlation coefficient. It is lots of data just clumped together in no real pattern and there is no ability for a trend line to be drawn through the plot. 
