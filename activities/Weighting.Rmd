...
The range of weights in this dataset goes from 0.2298 on the low end and 3.0386 on the high end.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

A weight of 0.23 most likely means that person was easy to find and similar to most of the people sampled in the poll. A weight of 3.04 most likely means that person was difficult to find and had significantly different responses than others.

3. Why might some respondents be weighted more heavily than others?

People will have their responses weighted different depending on if they are easy or hard to and how many other people with similar responses there were.
...
The rarely voter category shows the biggest difference between weighted and unweighted results for all three voting results.

2. How might these differences affect reporting on likely voter turnout?

If people who respond to surveys saying that they rarely vote decide to come out and vote in a certain election, they are going to have a stronger influence on the polls and affect the results. Pollsters typically assume that these people rarely come out to vote, but they have the most uncertainty and can affect the results the most.
...
These differences exist because people might respond to a survey a month before the election and say they are unlikely to vote, but then on election day decide maybe they should actually vote. These differences represent the people who say they rarely/never vote but then last minute decide to vote in any given election. They are the most unpredictable group and can easily be under represented in polls because pollsters have data that show they typically won't show up to vote. 
