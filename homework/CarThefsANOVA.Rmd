...
After calculating the results for each period, I found that unsurprisingly, the spike year had the highest theft rate, averaging almost 60 thefts per 100,000 people. Pre spike, PG county was averaging just over 23 car thefts per 100,000 people and post spike the number remained much higher at 43.3. This suggests that the theft rates do indeed differ significantly when comparing the three time periods.
...
This chart depicts the exact amount of car thefts each month from 2017-2025, and the blue line is the approximate line of best fit. The red dashed lines represent the car thefts that occurred during the spike in 2023. I think that a better title for this graph would be: Car rates reached peak level in 2023 before falling back down in 2024.
...
- **Null Hypothesis (H0)**: There is no difference in the car theft rates between the three time periods.

- **Alternative Hypothesis (H1)**: There is a statistically significant difference in the car theft rates between the three time periods.
...
Yes, there are real significant differences in average car theft rates between the time periods. The p-value is very low, indicating the differences between car theft rates in the different time periods are statistically significant at any reasonable significance level. The high f-value suggests that the differences between the time periods far outweigh the variation within each period.
...
The Tukey's test and confidence intervals show that there are statistically significant differences in car thefts rates between the three time periods. The difference between pre-spike and post-spike was -20.13 thefts per 100,00 with a 95% confidence interval ranging from about 24 to 16. Because this confidence interval does not include zero and there is such a low p-value, we can be confident that there is a significant difference.

Headline: Car thefts fell after 2023 surge, but remain above pre-spike levels
Lede: After car theft rates spiked dramatically in 2023, they have fallen back down, but not to pre-spike levels, data show. An analysis of the theft rates from 2017 to 2025 found that theft rates post-spike remain about 20 car thefts per 100,000 higher than pre-spike.
