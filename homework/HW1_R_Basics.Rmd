...
When I installed the tidyverse package in the library a lot of the code turned in the console section. I just want to make sure I didn't break or mess anything up?
When importing the csv file I couldn't figure out how to get it to work based on file pathing, I had to use the link provided. 
