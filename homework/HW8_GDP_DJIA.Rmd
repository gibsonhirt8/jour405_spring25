...
GDP_DJIA_data |> 
  ...
  labs(
    title = "Relationship between U.S. GDP and DJIA",
...
There is an extremely strong positive correlation between the DJIA and GDP. The correlation coefficient of 0.95 is very close to the maximum strength of 1 and confirms how strong the correlation in this relationship is. The scatterplot also helps confirm this correlation as the dots are closely formed around the linear regression line and form a sharp upwards slope.
